...
export const DataTableCrudDemo = () => {
    ...
    //boton de eliminar dentro de la tabla
            ...
            >
                ...
                <div className="p-formgrid p-grid">
                    <div className="p-field p-col">
                        ...
                        <InputNumber id="price" value={product.price} onValueChange={(e) => onInputNumberChange(e, 'price')} mode="currency" currency="CLP" locale="es-CL" />
                    </div>
                    <div className="p-field p-col">
